...
KAPI void renderer_sort_geometries(geometry_render_data* geometries, u32 count, b8 sort_by_camera_distance);
KAPI struct render_target* renderer_shadow_target_get();
KAPI struct texture* renderer_shadow_map_texture_get();
KAPI mat4 renderer_calculate_directional_light_space_matrix(vect3 light_dir, vect3 target_center);